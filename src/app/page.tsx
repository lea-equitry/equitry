  ...
  return (
    <div className="relative">
      ...
      <div className="overflow-hidden">
        ...
        >
          {looks.map((look, i) => (
            <div
              key={i}
              className="flex-none w-[calc(100%-2rem)] sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1rem)] group"
            >
      ...
      <button
        onClick={prev}
        disabled={current === 0}
        className="absolute -left-4 top-[40%] -translate-y-1/2 w-10 h-10 bg-cream border border-sage-lighter/40 flex items-center justify-center shadow-md hover:bg-sage-darkest hover:text-cream hover:border-sage-darkest transition-all duration-200 disabled:opacity-30 disabled:cursor-not-allowed z-10"
      ...
      <button
        ...
        className="absolute -right-4 top-[40%] -translate-y-1/2 w-10 h-10 bg-cream border border-sage-lighter/40 flex items-center justify-center shadow-md hover:bg-sage-darkest hover:text-cream hover:border-sage-darkest transition-all duration-200 disabled:opacity-30 disabled:cursor-not-allowed z-10"
